...
legend(1200, .250, legend = c("look w rt", "look wo rt", "sac w rt", "sac wo"), 
...
lines(trace_luce$time, trace_luce$targets, col = 'red')
lines(trace$time, trace$target*trace_luce$ss)
...
lines(time, f3, type = 'l', col = 'green')
lines(time, f4, type = 'l', col = 'purple')
legend(1200, .350, legend = c("look w rt", "look wo rt", "sac w rt", "sac wo", "trace"), 
       col = c("red", "blue", "green", "purple", "black"), lwd = 1)
lines(trace$time,  trace$ss_trace, lwd = 2)
