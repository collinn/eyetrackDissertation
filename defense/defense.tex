...
%\begin{itemize}
%\item bdots
%\item work on simulation for eye tracking/physiology
%\item using other parts of the data in larger model (number of saccades, search patterns, length of fixations, response time for whatever)
%\item Main one to talk about here -- oculomotor delay
%\end{itemize}
...
%% Could include some slides at the end showing bdots work for bonus
%
%\begin{frame}[fragile]{Non-vwp data - TEST SLIDE FOR R CODE}
...
%\end{frame}
%
%\begin{frame}{Plots- TEST SLIDE FOR COLUMNS}
