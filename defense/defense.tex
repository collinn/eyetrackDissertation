...
\begin{figure}[H]
\centering
    \subfigure{\includegraphics[width=0.6\textwidth]{no_delay_par_bias_onset.pdf}} 
    \subfigure{\includegraphics[width=0.6\textwidth]{no_delay_par_bias_proportion.pdf}} 
...
\centering
    \subfigure{\includegraphics[width=0.6\textwidth]{no_delay_par_bias_onset.pdf}} 
    \subfigure{\includegraphics[width=0.6\textwidth]{weibull_delay_par_bias_onset.pdf}} 
\caption{Parameter bias with no oculomotor delay}
\label{fig:par_bias_no_delay}
\end{figure}
\end{frame}
