...
ggplot(newdt, aes(x = time, y = fit, color = Condition)) + 
  ...
  scale_color_manual(values = c("Underlying" = "black", "No Delay" = "#F8766D"),
                     labels = c("Underlying", "No Delay" )) +
  theme_bw() + theme(legend.position = "bottom") + ggtitle("No Delay")
...
ggplot(newdt, aes(x = time, y = fit, color = Condition)) + 
  ...
  scale_color_manual(values = c("Underlying" = "black", "200ms Delay" = "#00BA38"),
                     labels = c("Underlying", "200ms Delay" )) +
  theme_bw() + theme(legend.position = "bottom") + ggtitle("200ms Delay")
```
...
ggplot(newdt, aes(x = time, y = fit, color = Condition)) + 
  ...
  scale_color_manual(values = c("Underlying" = "black", "Random Delay" = "#619CFF"),
                     labels = c("Underlying", "Random Delay" )) +
  theme_bw() + theme(legend.position = "bottom") + ggtitle("Random Delay")
```
