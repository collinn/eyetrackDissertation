...
\texttt{bboot} determines which groups specified in \texttt{bfit} are to be bootstrapped with a formula argument, using sytax unique to the \texttt{bdots} package.
