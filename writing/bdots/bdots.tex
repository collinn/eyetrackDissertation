...
Like the fitting function, the bootstrapping process has been consolidated to a single function, \texttt{bboot} (previously \texttt{bdotsBoot}). The bootstrapping function does new stuff
...
foreign/domestic $\rightarrow$ car/truck $\rightarrow$ red/blue
