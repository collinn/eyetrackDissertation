...
\subsection{Establishing Subject-Specific Curves}
...
An example vignette demonstrating the use of this function in more detail is included in the appendix. 

\cn{Need to elaborate here with example}
...
\subsection{Formula Syntax for Nested Groups and Difference of Differences} 
