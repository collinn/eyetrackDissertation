...
The simulations are performed in R, with the simulation code available on the author's Github page \cn{(link?)}. Simulated data was fit to the four parameter logistic function using \xt{bdots v2.0.0}.
