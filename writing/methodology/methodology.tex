...
\begin{figure}[H]
    \centering
    \subfigure[]{\includegraphics[width=0.45\textwidth]{paired_many_means_high_sig_dist_plot.pdf}} 
    \subfigure[]{\includegraphics[width=0.45\textwidth]{paired_single_means_high_sig_dist_plot.pdf}} 
...
\begin{figure}[H]
    \centering
    \subfigure[]{\includegraphics[width=0.45\textwidth]{paired_many_means_low_sig_dist_plot.pdf}} 
    \subfigure[]{\includegraphics[width=0.45\textwidth]{paired_single_means_low_sig_dist_plot.pdf}} 
    \caption{Paired bases, $\sigma = 0.005$ (a) Many means assumption, (b) single means distribution }
\label{fig:pair_low_sig_dist_plots}
\end{figure}

% latex table generated in R 4.2.2 by xtable 1.8-4 package
% Wed Feb  8 19:28:44 2023
\begin{table}[ht]
\centering
...
\begin{figure}[H]
    \centering
    \subfigure[]{\includegraphics[width=0.45\textwidth]{unpaired_many_means_high_sig_dist_plot.pdf}} 
    \subfigure[]{\includegraphics[width=0.45\textwidth]{unpaired_single_means_high_sig_dist_plot.pdf}} 
