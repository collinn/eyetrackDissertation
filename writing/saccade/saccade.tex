...
\item Introduce parametric forms to be fit to the data (the assumption we continue to run with)
\end{enumerate}
\end{enumerate}
\end{singlespace}
...
\end{enumerate}
\item idk im desribing this weird -- maybe come back to it
\end{enumerate}
\end{singlespace}
...
The entirety of the bias resulting from FBS and FBS+T were consequence of the fact that we were observing data points (0, 1) at the wrong times, constructing a curve whose shape was radically different -- that is, a different slope and crossover point.
