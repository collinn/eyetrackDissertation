...
%\textsc{\begin{figure}
%    \centering
%    \includegraphics[width=\textwidth]{img/vwp_example.png}
%    \caption{Illustration of eye mechanics}
%\end{figure}}
...
I need to download this data from Bob and just do it. Part of my hestitation, I believe, is the fact that it might not work. That would be shitty
