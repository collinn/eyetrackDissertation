...
[ive also included normal delay at the end for comparison -- i think the progression from no to normal to weibull is more dramatic, and normal is a pretty popular distribution, especially given how common the 200ms estimate is specifically. Of the normal, 965 were retained (oddly less than the rest)]
...
Look Onset & No Delay & 0.01 & 0.17 & 0.33 & 0.43 & 0.55 & 6.57 \\ 
  ...
  Proportion & Weibull Delay & 3.37 & 18.91 & 28.48 & 32.57 & 41.73 & 133.16 \\ 
   \hline
\end{tabular}
\caption{Summary of MISE across simulations. I don't think I necessarily need (or want) all of those summary stats (min/max specifically)}
\label{tab:mise_sims}
\end{table}

% latex table generated in R 4.2.2 by xtable 1.8-4 package
% Fri Feb 17 10:12:56 2023
\begin{table}[ht]
\centering
\begin{tabular}{llrrrrrr}
  \hline
Curve & Delay & Min. & 1st Qu. & Median & Mean & 3rd Qu. & Max. \\ 
  \hline
Look Onset & No Delay & 0.01 & 0.17 & 0.32 & 0.45 & 0.56 & 11.73 \\ 
  Look Onset & Uniform Delay & 0.02 & 0.49 & 0.91 & 1.26 & 1.68 & 8.23 \\ 
  Look Onset & Weibull Delay & 0.05 & 1.05 & 2.16 & 3.17 & 4.23 & 26.31 \\ 
  Look Onset & Normal Delay & 0.02 & 0.37 & 0.71 & 0.94 & 1.24 & 14.32 \\ 
  Proportion & No Delay & 1.97 & 8.21 & 11.33 & 12.51 & 16.01 & 39.15 \\ 
  Proportion & Uniform Delay & 2.42 & 20.38 & 28.74 & 30.99 & 38.93 & 94.06 \\ 
  Proportion & Weibull Delay & 0.44 & 15.27 & 24.75 & 28.80 & 38.14 & 169.03 \\ 
  Proportion & Normal Delay & 5.42 & 22.90 & 30.65 & 32.26 & 39.37 & 82.73 \\ 
   \hline
\end{tabular}
\label{alltables}
\end{table}
