...
Though not stated directly (given it predates bdots by 8 years), this also served as the impetus for investigating group differences in word activation through the use of bootstrapped differences in time series \citep{oleson2017detecting} and the subsequent development of the \xt{bdots} software in R for analyzing such differences. (A history of exploring differences in group curves can be found in \citet{seedorff2018bdots}).
...
\cn{This section needs to be tightened quite a bit.}
...
\begin{figure}[H]
    \centering
    \subfigure[]{\includegraphics[width=0.45\textwidth]{irl_data_prop_1}}
    \subfigure[]{\includegraphics[width=0.45\textwidth]{img/irl_data_onset_1}}
...
\begin{figure}[H]
    \centering
    \subfigure[]{\includegraphics[width=0.45\textwidth]{irl_data_prop_2}}
    \subfigure[]{\includegraphics[width=0.45\textwidth]{img/irl_data_onset_2}}
