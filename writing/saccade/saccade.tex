...
\cn{talk about here maybe linking hypothesis but i think this would be a good time to articulate the fact that look onset and duration of fixation governed by entirely separate processes. Also worthwhile to bring up that OM is AGAIN a separate process. so let's break these into different pieces and label the ones we know}
...
To be clear, this is not to say that the length of a fixation has no relevant information regarding the strength of activation, and indeed numerous studies (source?) have demonstrated this to be the case. Rather, we argue that by more clearly specifying the particular process that we are interested in, we can perform better recovery of the underlying mechanism. 
